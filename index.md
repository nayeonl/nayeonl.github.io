...
research_focus:
  ...
  areas:
    - title: Bio-mimicry
      icon: fas fa-leaf
      description: Biomechanics, biological materials, and bio-inspired design, including impact mitigation from periodic microstructures like woodpecker beaks.
    - title: Nanotextures
      icon: fas fa-microscope
      description: Investigating nanotextured surfaces with superhydrophobic or antibacterial properties experimentally and computationally.
    - title: Machine Learning
      icon: fas fa-brain
      description: Sensor-fusion and data analysis for prognostic health monitoring, signal data analysis, and anomaly prediction.
...
funding:
  - agency: U.S. Army ERDC
    project: AM Monitoring with Multifunctional Sensor Arrays - Prognostic Health Monitoring using Transfer Learning
    amount: $583,296
  - agency: MSU ORED
    project: Developing Nanotexture Using Frequency-Aid Anodization
    amount: $2,000
---
